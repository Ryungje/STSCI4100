...
#Since our 13 clusters do not correspond well with Genre, we can now explore the clusters of
...
#Note that there does not seem to be any relationship between the generated k-means groups and our film distributor data 
...
#Thus, according to our K-Fold Cross validation, we will proceed with the k=5 nearest neighbors
